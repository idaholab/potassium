 ...
 */
class PotassiumVaporFluidProperties : public SinglePhaseFluidProperties, public NaNInterface
{
public:
  PotassiumVaporFluidProperties(const InputParameters & parameters);
